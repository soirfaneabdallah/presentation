...
\institute{
  ...
  \begin{picture}(3.5cm,2cm) 
        \put(-100,20){\includegraphics[height=1.2cm,keepaspectratio]{udc.jpeg}}
...
\setbeamertemplate{footline}{
	\hfill \textcolor{gray}{\scriptsize \textbf{6\up{ème} Édition des Journées Scientifiques de la FST}-- \textcolor{espoircolor}{\textbf{\textit{Le numérique au service du vivant}}}} \hspace{0.5cm}
	\vspace{0.2cm}
}
\begin{document}
\typesetFrontSlides
